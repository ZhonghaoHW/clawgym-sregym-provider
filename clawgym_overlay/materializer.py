...
def materialize_reference_profile(*, proposal_path: str | Path, component_bundle_path: str | Path, parent_profile_path: str | Path, output_dir: str | Path, runtime_reference: str) -> dict[str, Any]:
    ...
    profile.update({"schema_id": "clawgym.sregym_reference_agent_profile.v2", "sop_variant": "materialized-reference-v1", "bounded_execution": {"diagnosis_max_steps": bundle["diagnosis_step_limit"], "mitigation_max_steps": bundle["mitigation_step_limit"], "container_timeout_seconds": 900}, "config_bundle_digest": config["config_bundle_digest"], "component_bundle_digest": bundle["component_bundle_digest"], "semantic_component_digest": component_digest, "materializer_runtime_reference": runtime_reference})
